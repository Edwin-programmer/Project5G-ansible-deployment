...
5G cloud-native orchestration using containers and automation to deploy Cloud Native Network Functions: OpenAirInterface (OAI), Cloud Radio Access Network (CloudRAN) and 5G core network functions
